...
void CemuConfig::Load(XMLConfigParser& parser)
{
	...
	emulated_usb_devices.dimensions_toypad_listener_port = usbdevices.get("DimensionsToypadListenerPort", emulated_usb_devices.dimensions_toypad_listener_port);
}
...
void CemuConfig::Save(XMLConfigParser& parser)
{
	...
	usbdevices.set("DimensionsToypadListenerPort", emulated_usb_devices.dimensions_toypad_listener_port.GetValue());
}
